(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (The Goldman Sachs Group, Inc.,
  LEI 784F5XWPLTWKTBV3E584) -- unlike `commitledger.store`'s
...
(def ^:private demo-full-text
  "Terms and Conditions\nThese Terms and Conditions govern your access to and use of The Goldman Sachs Group, Inc. websites. By using this site you agree to these Terms, which are subject to change without notice. This agreement is governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.goldmansachs.com/terms-and-conditions.html"
